...
public class Main {
    ...
    public static Map<String, Object> userScan() {
        ...
        System.out.println("какой размер оперативной памяти вы бы хотели расмотреть?: ");
        if (scanner.hasNextInt()) {
        ...
        while (true) {
            ...
            if (input.equalsIgnoreCase("да")) {
                ...
                System.out.println("какой объём жёсткого диска вы бы хотели расмотреть?: ");
                if (scanner.hasNextInt()) {
                ...
                if (userList.containsKey("os")) {
                    ...
                    if (userList.containsKey("hdd")) {
                        ...
                        if (laptop.getHdd() < (int) userList.get("hdd")) {
                            ...
                            System.out.println("Введённые вами параметры жёсткого диска превышают на" + difference + ",хотели бы рассмотреть другой объём ram этого ноутбука да/нет?: ");
    ...
    public static void main(String[] args) {
        ...
        for (Laptop laptop : laptops) {
            ...
            // и добавляем список ноутбуков для модели котороая находится на этом этапе итерации
...
//        Map<String, List<Laptop>> laptopsByModel = modelLaptops;
        ...
        // пока пользователь не определится м критериями подходящими под описания ноутбуков имеющихся в каталоге
        while (flag) {
